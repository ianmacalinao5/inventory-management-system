<div class="flex h-16 items-center justify-center gap-3 border-b border-gray-200 px-6">
	<div class="flex h-10 w-10 items-center justify-center rounded-lg bg-blue-600 shrink-0">
