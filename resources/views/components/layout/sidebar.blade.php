...
<body x-data="{ sidebarOpen: true }" class="h-full bg-gray-100 text-gray-900 antialiased">
	<div class="flex h-full">

		<!-- Sidebar -->
		<aside :class="sidebarOpen ? 'w-64' : 'w-21'"
				...
				<div class="space-y-1">
					...
					<x-nav-link route="products" href="{{ route('products.index') }}">
						...
						<span x-show="sidebarOpen"
							class="ml-auto rounded-full bg-blue-100 px-2 py-0.5 text-xs font-medium text-blue-700">248</span>
					</x-nav-link>
					...
					<x-nav-link route="categories" href="{{ route('categories') }}">
		...
		<!-- Main Content Area -->
		<div :class="sidebarOpen ? 'pl-64' : 'pl-20'" class="flex flex-1 flex-col transition-all duration-300">
			<x-header />
